...
barplot(agSumStepsDay$steps, names.arg= agSumStepsDay$date, cex.names=0.5,cex.axis=0.5,las=2, col="cornflowerblue", main="The Total Number of Steps Taken Each Day", xlab="Date", ylab="Steps")
```
...
barplot(agSumStepsDayNoNA$steps, names.arg= agSumStepsDayNoNA$date, cex.names=0.5,cex.axis=0.5,las=2, col="cornflowerblue", main="The Total Number of Steps Taken Each Day", xlab="Date", ylab="Steps")
```
